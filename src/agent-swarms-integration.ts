    ...
    private initializeAgentRegistry(): void {
        ...
        const agentMappings: Record<string, AgentManifest> = {
            "architect-advisor": {
                ...
                description:
                    "System architecture and technical decision guidance",
                capabilities: [
                    {
                        name: "architecture",
                    ...
                    {
                        name: "scalability",
                        description: "Scalability analysis and planning",
                        confidence: 0.9,
                    },
                    {
                        name: "design",
                        description: "Technical design and trade-off analysis",
                        confidence: 0.85,
                    },
                ],
            ...
            "prompt-optimizer": {
                ...
                description:
                    "Prompt enhancement using research-backed techniques",
                capabilities: [
                    {
            ...
            "docs-writer": {
                ...
                description:
                    "Specialized documentation page writer with specific formatting rules",
                capabilities: [
                    {
                        name: "documentation",
                    ...
                    },
                    {
                        ...
                        description: "Content creation and formatting",
                        confidence: 0.9,
                    },
                    {
                        name: "technical-writing",
                        description: "Technical writing and editing",
                        confidence: 0.85,
                    },
                ],
            ...
            "documentation-specialist": {
                ...
                description:
                    "Comprehensive technical documentation generation and API docs",
                capabilities: [
                    {
                        name: "documentation",
            ...
            "java-pro": {
                ...
                name: "Java Pro",
                description:
                    "Java development with modern features and enterprise patterns",
                capabilities: [
                    {
                        name: "java",
                        description: "Java development expertise",
                        confidence: 0.95,
                    },
                    {
                        name: "spring",
                        description: "Spring Boot and Spring Framework",
                        confidence: 0.9,
                    },
                    {
                        name: "enterprise",
                        description: "Enterprise Java patterns",
                        confidence: 0.85,
                    },
                    {
                        name: "jvm",
                        description: "JVM optimization and tuning",
                        confidence: 0.8,
                    },
                ],
                handoffs: [
                ...
                capabilities: [
                    {
                        ...
                        description: "Cloud cost analysis and reduction",
                        confidence: 0.95,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        description: "Cloud pricing and budgeting",
                        confidence: 0.85,
                    },
                ],
            ...
            "ai-engineer": {
                ...
                capabilities: [
                    ...
                    {
                        name: "embeddings",
                        description: "Vector embeddings and search",
                        confidence: 0.85,
                    },
                ],
                handoffs: [
            ...
            "ml-engineer": {
                ...
                capabilities: [
                    ...
                    {
                        name: "data-science",
                        description: "Data analysis and feature engineering",
                        confidence: 0.8,
                    },
                ],
                handoffs: [
            ...
            "agent-creator": {
                ...
                capabilities: [
                    ...
                    },
                    {
                        ...
                        description: "Agent prompt engineering",
                        confidence: 0.9,
                    },
                    {
            ...
            "command-creator": {
                ...
                capabilities: [
                    {
                        name: "command-design",
                        description: "CLI command architecture",
                        confidence: 0.95,
                    },
                    {
                        name: "workflow-automation",
                        description: "Workflow automation patterns",
                        confidence: 0.9,
                    },
                    {
                        name: "cli-ux",
            ...
            "skill-creator": {
                ...
                capabilities: [
                    {
                        name: "skill-design",
                        description: "Skill architecture and structure",
                        confidence: 0.95,
                    },
                    {
                        name: "knowledge-modeling",
                        description: "Domain knowledge organization",
                        confidence: 0.9,
                    },
                    {
                        name: "documentation",
                        description: "Skill documentation best practices",
                        confidence: 0.85,
                    },
                ],
                handoffs: ["plugin-validator", "agent-creator"],
            ...
            "tool-creator": {
                ...
                capabilities: [
                    {
                        name: "tool-design",
                        description: "Tool API design",
                        confidence: 0.95,
                    },
                    {
                        name: "integration",
                        description: "Tool integration patterns",
                        confidence: 0.9,
                    },
                    {
                        name: "api-design",
                        description: "Tool interface design",
                        confidence: 0.85,
                    },
                ],
            ...
            "plugin-validator": {
                ...
                description:
                    "Plugin structure validation and best practices enforcement",
                capabilities: [
                    {
                        name: "validation",
                    ...
                    {
                        name: "best-practices",
                        description: "Plugin best practices",
                        confidence: 0.9,
                    },
                    {
                        name: "compatibility",
        ...
        for (const agent of this.agentRegistry.values()) {
            const hasCapabilities = requiredCapabilities.every((requiredCap) =>
                agent.capabilities.some(
                    (agentCap) =>
                        agentCap.name === requiredCap &&
                        agentCap.confidence >= minConfidence,
                ),
            );
...
export function getAgentSwarmsIntegration(
