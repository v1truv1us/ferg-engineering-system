| description | mode |
|---|---|
| Use this agent when user asks to "write documentation", "create docs page", "generate technical docs", or describes documentation writing needs. Examples: | subagent |
