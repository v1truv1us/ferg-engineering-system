...
# In OpenCode, try typing:
 /ai-eng/
 ```
 **Expected**: Auto-complete shows all ai-eng commands
...
```bash
/ai-eng/review "https://github.com/v1truv1us/ai-eng-system/pull/2"
```
**Expected Output**:
- Code review with:
  - Quality assessment
...
- **Releases**: https://github.com/v1truv1us/ai-eng-system/releases
