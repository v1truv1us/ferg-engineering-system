...
export class SkillSwarmsIntegration {
  ...
  private initializeSkillRegistry(): void {
    const skillMappings: Record<string, SkillDefinition> = {
      'comprehensive-research': {
        ...
        version: '1.0.0',
        capabilities: ['research', 'analysis', 'documentation', 'discovery'],
        parameters: [
          {
            name: 'query',
            type: 'string',
          ...
          },
          {
            name: 'scope',
            type: 'string',
            description: 'Scope of research (codebase, external, both)',
            required: false,
            default: 'codebase'
          },
          {
      ...
      'coolify-deploy': {
        ...
        version: '1.0.0',
        capabilities: ['deployment', 'devops', 'infrastructure', 'monitoring'],
        parameters: [
          {
            name: 'environment',
            type: 'string',
      ...
      'git-worktree': {
        ...
        version: '1.0.0',
        capabilities: ['git', 'workflow', 'branching', 'version-control'],
        parameters: [
          {
            name: 'action',
            type: 'string',
            description: 'Action to perform (create, list, remove, switch)',
            required: true
          },
          {
            name: 'branch',
      ...
      'incentive-prompting': {
        ...
        version: '1.0.0',
        capabilities: ['prompt-engineering', 'ai-interaction', 'optimization'],
        parameters: [
          {
            name: 'task',
            type: 'string',
      ...
      'plugin-dev': {
        ...
        description: 'Plugin development knowledge base and best practices',
        version: '1.0.0',
        capabilities: ['plugin-development', 'extension-tools', 'integration'],
        parameters: [
          {
            name: 'platform',
            type: 'string',
          ...
          },
          {
            name: 'component',
            type: 'string',
            description: 'Component type (agent, command, skill, tool)',
            required: true
          },
          {
            name: 'template',
    ...
    Object.values(skillMappings).forEach(skill => {
      this.skillRegistry.set(skill.name.toLowerCase().replace(/\s+/g, '-'), skill);
    });
  }
   ...
   */
  private async executeSkill(skillName: string, params: Record<string, any>): Promise<any> {
    ...
    switch (skillName) {
      ...
      case 'coolify-deploy':
        return {
          ...
          checklist: ['Verify environment variables', 'Check database migrations', 'Validate monitoring setup']
        };
  ...
  async createSkillSwarm(
    ...
    const allCapabilities = [...skill.capabilities, ...additionalCapabilities];
...
export function getSkillSwarmsIntegration(swarmsClient?: SwarmsClient): SkillSwarmsIntegration {
