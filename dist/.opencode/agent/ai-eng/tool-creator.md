| description | mode |
|---|---|
| AI-assisted TypeScript tool creation for OpenCode. Creates properly formatted custom tools with Zod validation. Use when user asks to "create a tool", "build a custom tool", "make a tool that...", or needs TypeScript tool development assistance. | subagent |
